...
namespace WillCorp.HostService
{
    class Program
    {
            ...
            var host = HostFactory.New(config =>
            {
                ...
                config.Service<ServiceHost>(s =>
               {
                ...
                config.EnableServiceRecovery(r =>
                {
                    ...
                    //should this be true for crashed or non-zero exists
                    r.OnCrashOnly();
                ...
                config.SetDescription("Demo showing how to create an extensible windows service capable of running multiple modules");
            });
        ...
        /// <summary>
        /// Register services here; the Standard container
